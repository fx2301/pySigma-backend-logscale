...
# FIXME from sigma.pipelines.logscale import # TODO: add pipeline imports or delete this line
import sigma
import re
...
class LogScaleBackend(TextQueryBackend):
    ...
    name : ClassVar[str] = "LogScale backend"
    ...
    # NOTE LogScale supports field = "*value*" wildcard queries already
